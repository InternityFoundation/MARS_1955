...
predictor = dlib.shape_predictor("D:\\Stress-Detection-master\\shape_predictor_68_face_landmarks (1).dat")
emotion_classifier = load_model("D:\\Stress-Detection-master\\_mini_XCEPTION.102-0.66.hdf5", compile=False)
...
while(True):
    ...
    for detection in detections:
        ...
        cv2.putText(frame,"stress level:{}".format(str(float(stress_value*100))),(20,40),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
